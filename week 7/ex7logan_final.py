...
class logAnalyzer:
    ...
    def docReader(self):
        ...
        try:
            ...
            print("File nout found, stopping...")
    ...
    def getMostRequestedURL(self):
        ...
        print("Most requested URL: ", highestEntry)
    ...
    def getPeakTrafficTimes(self):
        ...
        print("Peak time: ", highestKey, ":00 with ", highest, " requests")
    ...
    def getFailedAttempts(self):
        ...
        for attempt in self.structuredLog:
            if 199 < int(attempt[8]) < 399:
                print("Successful access with status code: ", attempt[8])

            elif int(attempt[8]) == 403:
                print("Forbidden access attempt from IP:", attempt[0])
            else:
                print("Failed login from IP: ", attempt[0], "with error code: ", attempt[8])
        ...
        print("Brute-Force Log (IP/attempts > 1)", self.bruteLog)
